...
const inventorsReduce = inventors.reduce((total,obj) => total + obj.passed - obj.year, 0)
console.log(inventorsReduce);

// 5. Sort the inventors by years lived

const inventorsSortYear = inventors.sort((a,b) => a.passed - a.year > b.passed - b.year ? -1 : 1);
...
const sumup = data.reduce(function(traffic, obj){
  if (!traffic[obj]) {
    traffic[obj] = 0
  }
  traffic[obj]++;
